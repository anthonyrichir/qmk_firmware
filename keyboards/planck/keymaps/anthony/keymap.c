...
[_COLEMAK] = LAYOUT_planck_grid(
    ...
    BACKLIT, KC_LCTL, BE_LGUI, BE_LALT, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_ADJUST] = LAYOUT_planck_grid(
    ...
    _______, _______, MU_MOD,  AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, AZERTY,  COLEMAK,  DVORAK,  PLOVER,  _______,
